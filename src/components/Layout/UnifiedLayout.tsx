  ...
  const navSections: NavSection[] = [
    ...
    // Work Section - CHW Tools based on user type
    {
      ...
      items: [
        ...
        { href: '/referrals', icon: Send, label: 'Referrals', roles: [UserRole.ADMIN, UserRole.NONPROFIT_STAFF, UserRole.CHW, UserRole.WL4WJ_CHW] },
        ...
        { href: '/datasets', icon: Database, label: 'Datasets', roles: [UserRole.ADMIN, UserRole.NONPROFIT_STAFF, UserRole.WL4WJ_CHW] },
        { href: '/reports', icon: BarChart3, label: 'Reports', roles: [UserRole.ADMIN, UserRole.NONPROFIT_STAFF, UserRole.WL4WJ_CHW] },
