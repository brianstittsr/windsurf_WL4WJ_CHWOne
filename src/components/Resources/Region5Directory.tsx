        ...
        <Col>
          <div className="d-flex justify-content-between align-items-center">
            <div>
              ...
              <p className="text-muted">Comprehensive resource directory for community health workers in Region 5</p>
            </div>
      ...
      <Row className="mb-4">
        <Col>
          <Alert variant="success">
            ...
            <strong>NC C.A.R.E. 360 Integration Active</strong> - Resources are synchronized with the statewide coordinated care network.
          </Alert>
        </Col>
      </Row>
